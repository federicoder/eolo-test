...
import { ClienteFrontendComponent } from 'app/entities/cliente-frontend/cliente-frontend.component';
...
describe('Component Tests', () => {
  describe('ClienteFrontend Management Component', () => {
    let comp: ClienteFrontendComponent;
    let fixture: ComponentFixture<ClienteFrontendComponent>;
    let service: ClienteFrontendService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [EoloTestTestModule],
        declarations: [ClienteFrontendComponent],
        providers: [
          {
        ...
        .overrideTemplate(ClienteFrontendComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ClienteFrontendComponent);
